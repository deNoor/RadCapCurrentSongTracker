...
public partial class Settings
{
    ...
    public static Settings Default { get; } = new()
    {
        ...
        Directory = Path.Combine(BasePath, "ObsNowPlaying"),
    ...
    internal static string FullPath { get; } = Path.Combine(BasePath, FileName);
    ...
    public bool AreInvalid(out string message)
    {
        ...
        static string CreateMessage(string reason) => $"{reason}, check {FullPath} or delete it to reset to default.";
    }
    ...
    public async Task InitAsync(CancellationToken cancellationToken)
    {
        ...
        {
            await using var fs =
                new FileStream(FullPath, FileMode.Create, FileAccess.Write, FileShare.None, 4096, FileOptions.Asynchronous);
